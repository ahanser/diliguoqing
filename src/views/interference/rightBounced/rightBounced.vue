  ...
  <div>
    ...
    <div class="switchTab"
      ...
      <div class="bounceEcharts"
           v-show="ok">
        <i v-show="ok1"><img src="static/img/human.png" /><em @click="ok1=false">X</em></i>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      checkedCities11: ["201810230000COOD"],
      cities: [
        "201812230000COOD",
        "201811230000COOD",
        "201810230000COOD",
  ...
  computed: {
    ...mapGetters("human", ["rightBounceArr"])
  },
  watch: {
  ...
  methods: {
    ...
    ...mapActions("human", ["rightListArr"]),
    init() {
      this.$store.dispatch("human/rightListArr", false);
    }
  },
  mounted() {
    this.init();
