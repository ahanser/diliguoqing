...
export default {
  ...
  methods: {
    ...mapActions("val", ["changeListArr","getMapCity"]),
    ensure() {
      ...
      this.$store.dispatch("val/changeListArr", array);
      this.$store.dispatch("val/getMapCity", cityChecked);
    },
    //行政区域
